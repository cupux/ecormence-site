...
stripe.api_key = "sk_test_yoXm3f7vQLbc1TJT5uTNlNv100a9AGoZpA"
    ...
    def post(self,*args, **kwargs):
        ...
        if form.is_valid():
            ...
            try:
                ...
                messages.warning(self.request, "A seeious error occured. We have been noticfied")
                return redirect("/")
...
def remove_from_cart(request, slug):
    ...
    if order_qs.exists():
        ...
        # add a message saying the user deosnt have
        return redirect("core:product",slug=slug)
    return redirect("core:product",slug=slug)
...
def get_coupon(request, code):
    try:
        ...
        messages.info(request, "Coupon dont exist")
        return redirect("core:checkout")
    ...
    def post(self, *args, **kwargs):
        ...
        if form.is_valid():
            try:
                ...
                order.save()
                messages.success(self.request, "Successfully sdded coupon")
                return redirect("core:checkout")
            except ObjectDoesNotExist:
                messages.info(self.request, "You do not have an active order")
                return redirect("core:checkout")
